...
if len(existing_test) > 0:
    ...
    print(f"Number of images in Train dir: {len(list(train_img_dir.rglob('*_leftImg8bit.png')))}")
    print(f"Number of images in Test dir: {len(list(test_img_dir.rglob('*_leftImg8bit.png')))}")
